...
import { DemoTree, DemoTreeOptimized, DemoTreeOptimizedContent, DemoTreeOptimizedContent1, DemoTreeOptimizedContent2 } from "@/components/2-main/2-demo/demo-tree";
...
export const showcasesData: Showcase[] = [
    ...
    { id: '41', name: "Tree", component: <DemoTreeOptimized children1={<DemoTreeOptimizedContent1 />} children2={<DemoTreeOptimizedContent2 />} /> },
    // { id: '41', name: "Tree", component: <DemoTreeOptimized> <DemoTreeOptimizedContent /> </DemoTreeOptimized> },
